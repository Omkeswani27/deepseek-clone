    ...
    <div>
      <div className="flex h-screen">
        ...
        <div className="flex-1 flex flex-col items-center justify-center px-4 pb-8 bg-[#292a2d] text-white relative">
          ...
          (<div ref={containerRef} className="relative flex flex-col items-center justify-start w-full max-h-screen mt-20 overflow-y-auto">
...

            {
              isLoading && (
                <div className="flex gap-4 max-w-3xl w-full py-3">
                  <Image className="h-9 w-9 border border-white/15 rounded-full" src={assets.logo_icon} alt=""/>
